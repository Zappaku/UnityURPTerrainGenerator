...
public class TerrainGeneratorEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        TerrainGenerator.TerrainPreset newPreset = (TerrainGenerator.TerrainPreset)EditorGUILayout.EnumPopup("Terrain Preset", 
            terrainGenerator.terrainPreset);
        ...
        if (terrainGenerator.terrainPreset != TerrainGenerator.TerrainPreset.Desert)
        {
            terrainGenerator.waterTerrainLayer = (TerrainLayer)EditorGUILayout.ObjectField("Shoreline/Underwater Layer", 
        ...
        terrainGenerator.waterMaterial = (Material)EditorGUILayout.ObjectField("Water Material", 
            terrainGenerator.waterMaterial, typeof(Material), false);
